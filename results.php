...
$run_pro = mysqli_query($con,$get_pro);
    ...
    while($row_pro = mysqli_fetch_array($run_pro)){
        ...
        <div class='prod_details_tab'> <a href='results.php?addcart=$product_id' title='header=[Add to cart] body=[&nbsp;] fade=[on]''><img src='images/cart1.png' alt='' border='0' class='left_bt' /></a>
