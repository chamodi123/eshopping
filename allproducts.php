...
<div class="title_box">BRANDS</div>
 ...
 <br>
      ...
      <div class="banner_adds"> <a href="#"><img src="images/bann.png" alt="" border="0" /></a> </div>
...
$get_pro = "select * from products";
    ...
    while($row_pro = mysqli_fetch_array($run_pro)){
        ...
        <div class='prod_details_tab'> <a href='allproducts.php?addcart=$product_id' title='header=[Add to cart] body=[&nbsp;] fade=[on]''><img src='images/cart1.png' alt='' border='0' class='left_bt' /></a>
