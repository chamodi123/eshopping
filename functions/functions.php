...
function getpro(){
    ...
    while($row_pro = mysqli_fetch_array($run_pro)){
        ...
        <div class='prod_details_tab'> <a href='index.php?addcart=$product_id' title='header=[Add to cart] body=[&nbsp;] fade=[on]''><img src='images/cart1.png' alt='' border='0' class='left_bt' /></a>
          <a href='details.php?pro_id=$product_id' class='prod_details'>Buy It Now</a> </div>
      </div>
    ...
    while($row_pro = mysqli_fetch_array($run_pro)){
        ...
        <div class='oferta_content'> <img src='admin_area/product_images/$product_image' width='94' height='92' alt='' border='0' class='oferta_img' />
          <div class='oferta_details'>
            ...
            <a href='details.php?pro_id=$product_id' class='details'>&nbsp &nbsp &nbsp Buy It Now</a> </div>
    ...
    echo"
        ...
        <div class='center_prod_box_big'>
          ...
          <div class='details_big_box'>
            ...
            <a href='details.php?addcart=$product_id' class='addtocart'>add to cart</a> <a href='index.php' class='buy'>Buy It Now</a> </div>
        </div>
...
function get_pro_cat(){
    ...
    while($row_pro_cat = mysqli_fetch_array($run_pro_cat)){
        ...
        <div class='bottom_prod_box'></div>
        <div class='prod_details_tab'> <a href='index.php?pro_id=$product_id' title='header=[Add to cart] body=[&nbsp;] fade=[on]''><img src='images/cart1.png' alt='' border='0' class='left_bt' /></a>
          <a href='details.php?pro_id=$product_id' class='prod_details'>Buy It Now</a> </div>
      </div>
